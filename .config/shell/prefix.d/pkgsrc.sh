...
if [ -z "${MY_PKGSRC:-}" ]; then
	for pfx in "$HOME/opt/pkg-2025Q1" "$HOME/opt/pkg-2025Q2" "$HOME/opt/pkg-2025Q3" "$HOME/opt/pkg-2025Q4" \
		"$HOME/opt/pkg-2026Q1" "$HOME/opt/pkg-2026Q2" "$HOME/opt/pkg-2026Q3"; do
